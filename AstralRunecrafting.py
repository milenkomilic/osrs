...
def is_any_pouch_broken():
    ...
    end_time = time.time()
    execution_time = end_time - start_time
    print(f"Execution time(is_any_pouch_broken): {execution_time} seconds")
    if np.any(matches):
        return "Found"
    else:
        return "Not Found"
...
def withdraw_1_from_bank_slot_2():
    box_left = 126
    box_top = 117
    box_right = 147
    box_bottom = 133
    ...
    pyautogui.moveTo(click_x, click_y+40, randomt)
    pyautogui.click()

def withdraw_1_from_bank_slot_3():
    box_left = 175
    box_top = 113
    box_right = 201
    box_bottom = 135
...
def consume_inv_4():
    ...
    randomt = random.uniform(0.06, 0.09)
    pyautogui.moveTo(click_x, click_y, randomt)
        ...
        for x in range(0, 3):
            ...
            if is_any_pouch_broken() == "Found":
                ...
                while is_bank_open() == "Not Found":
                    time.sleep(1.5 + randomt)
                    click_on_dark_green()
                    time.sleep(1.6 + randomt)
                else:
                    if is_hp_below_half() == "Found":
                        withdraw_1_from_bank_slot_3()
                        time.sleep(0.6 + randomt)
                        consume_inv_4()
                        time.sleep(0.5 + randomt)
                    if counter == 2:
                        withdraw_1_from_bank_slot_2()
                        time.sleep(0.7 + randomt)
                        consume_inv_4()
                        time.sleep(0.7 + randomt)
                        click_inv_slot_4()
                        time.sleep(0.33 + randomt)
                        click_inv_slot_4()
                        time.sleep(0.34 + randomt)
